...
-- CreateEnum
CREATE TYPE "PlanDuration" AS ENUM ('ONE_HOUR', 'SIX_HOURS', 'TWELVE_HOURS');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAID', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "PaymentPurpose" AS ENUM ('PLAN', 'ORDER');
...
-- CreateIndex
CREATE INDEX "UserPlan_isActive_expiresAt_idx" ON "UserPlan"("isActive", "expiresAt");
